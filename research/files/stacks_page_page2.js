...
// Javascript for com_stacks4stacks_stacks_switcher2
// ---------------------------------------------------------------------
...
var jQuery = stacks.jQuery;var $ = jQuery;$(document).ready(function() {
	...
	$('#accordionInterfacestacks_in_89 .accordion-toggle').attr('href', function(i) {
		return '#switcher1'+(i+1);
	});
	
	// Loop through our Switcher and give each accordion toggle a unique class value
	$('#accordionInterfacestacks_in_89 .accordion-toggle').attr('data-trigger', function(i) {
		return '#switcher1'+(i+1);
	});
	
	// Loop through our Switcher and give each accordion content pane a unique ID
	$('#accordionInterfacestacks_in_89 .accordion-content').attr('id', function(i) {
		return 'switcher1'+(i+1);
	});
	
	// Loop through our Switcher and give each tab toggle a unique href value
	$('#tabbedInterfacestacks_in_89 .accordion-toggle').attr('href', function(i) {
		return '#tab-switcher1'+(i+1);
	});
	
	// Loop through our Switcher and give each content pane a unique ID
	$('#tabbedInterfacestacks_in_89 .accordion-content').attr('id', function(i) {
		return 'tab-switcher1'+(i+1);
	});
	
	// Append opened and closed icons to the accordion heading toggles	
	$( "#accordionInterfacestacks_in_89 > li > .accordion-toggle" ).each(function() {
	...
	$("#accordionInterfacestacks_in_89 .accordion-toggle").clone().appendTo("ul#switcherTabsstacks_in_89");
	$("#accordionInterfacestacks_in_89 .accordion-content").clone().prependTo("#tabPanesstacks_in_89");
	$("ul#switcherTabsstacks_in_89 .accordion-toggle").wrap("<li class='switcherTab' />");
	
	// Intiate accordion
	$('#accordionInterfacestacks_in_89').accordion({
		animate: 500,
		...
		beforeActivate: function( event, ui ) {
			$("#switcherstacks_in_89 video").each(function () { this.pause() });
			$("#switcherstacks_in_89 audio").each(function () { this.pause() });
			$("#switcherstacks_in_89 iframe").each(function() { 
	...
	// Initiate tabs
	$('#tabbedInterfacestacks_in_89').tabs({
		animate: 500,
	...
	$("#switcherstacks_in_89").delay(transitionspeed).slideDown(transitionspeed);
